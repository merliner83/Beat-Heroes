                ...
                >
                  <Card className={cn(
                    ...
                    <div className="flex justify-between items-center text-white relative z-10">
                      <div>
                        <h3 className="text-3xl font-black uppercase italic tracking-tighter">{project.name}</h3>
                        <p className="text-sm opacity-50 font-bold tracking-widest uppercase mt-1">{project.bpm} BPM</p>
                      </div>
                      ...
                      {isLoadingLevels ? (
                        ...
                        levels?.sort((a,b) => a.difficulty - b.difficulty).map((level) => (
                          <Button
                            ...
                            variant="ghost"
                            className="h-24 bg-white/5 hover:bg-white/10 gemini-border border-transparent hover:gemini-glow text-lg font-black flex flex-col items-center justify-center gap-1 group transition-all rounded-2xl"
                          >
                            <span className="text-[10px] opacity-40 font-black uppercase tracking-[0.2em]">Level {level.difficulty}</span>
                            <div className="flex items-center gap-1 uppercase italic">
                              {level.name || 'Untitled'}
