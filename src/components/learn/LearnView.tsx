...
import { LearnApp, Article, hasAccess, SubCategory } from '@/lib/game/types';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export const LearnView = () => {
  ...
  const subCategoriesQuery = useMemoFirebase(() => db ? query(collection(db, 'subCategories')) : null, [db]);
